#!/bin/bash
#SBATCH --job-name=ghb_stride_fdp_649   # Job name
...
/scratch/user/vaishnav.g/ecen676/hw1/ChampSim/dpc3_traces/649.fotonik3d_s-1176B.champsimtrace.xz \
> ../results/ghb_stride_fdp/ghb_stride_fdp_649.txt
echo "Finished running 649.fotonik3d_s-1176B.champsimtrace.xz"
